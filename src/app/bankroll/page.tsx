...
import { equity, historyRows } from "@/lib/mock-data";
...
const periodDeltaMap: Record<Period, string> = {
  "7": "+4,8 u",
  "30": "+12,3 u",
  all: "+48,6 u",
};
...
const kpis: { label: string; value: string; color?: string }[] = [
  { label: "Yield", value: "+7,9 %", color: "#16C784" },
  { label: "ROI", value: "+48,6 %", color: "#16C784" },
  { label: "Taux de réussite", value: "54,2 %" },
  { label: "Cote moyenne", value: "1,92" },
  { label: "Paris réglés", value: "612" },
  { label: "Série gagnante max", value: "9", color: "#16C784" },
  { label: "Série perdante max", value: "6", color: "#EA3943" },
  { label: "Drawdown max", value: "−14,2 u", color: "#EA3943" },
];
...
export default function BankrollPage() {
  ...
  const periodDelta = periodDeltaMap[period];
        ...
        <div className="flex justify-between items-start flex-wrap gap-[14px] mb-2">
          ...
          <div>
            ...
            <p className="font-heading font-bold text-[32px] text-vb-text leading-none">
              148,6 u{" "}
              <span className="text-[15px] text-vb-green font-semibold">
                ▲ {periodDelta}
              </span>
            </p>
          </div>
        ...
        <div className="bg-vb-bg-card-solid border border-vb-border rounded-[18px] p-6">
          ...
          <div className="mb-4">
            <div className="flex justify-between items-center mb-[6px]">
              <span className="text-[13px] text-vb-text-body">
                ⚽ Football · 358 paris
              </span>
              <span className="text-[13px] font-semibold text-vb-green">
                +28,4 u
              </span>
            </div>
            <div className="h-[9px] bg-white/[0.06] rounded-[6px] overflow-hidden">
              <div
                className="h-full rounded-[6px]"
                style={{
                  width: "58.5%",
                  background: "linear-gradient(90deg, #16C784, #0FA76C)",
                }}
              />
            </div>
          </div>
          ...
          <div className="flex gap-[14px] flex-wrap">
            <div className="flex-1 min-w-[120px] bg-black/20 rounded-xl p-[14px]">
              ...
              <p className="text-[11px] text-vb-text-secondary">
                6 paris perdants d&apos;affilée · mars
              </p>
            </div>
            <div className="flex-1 min-w-[120px] bg-black/20 rounded-xl p-[14px]">
